...
using MagicLockScreen_Service_LunarPODService.UI.ViewModels;
...
namespace MagicLockScreen_Service_LunarPODService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class LunarPODServiceChannelPage : LayoutAwarePage
    {
        public LunarPODServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new LunarPODServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding {Source = FindName("lunarPODItemsViewSource") as CollectionViewSource});
