...
namespace MagicLockScreen_Service_NationalGeographicService.UI.Views
{
    ...
    /// </summary>
    public sealed partial class NationalGeographicViewPage : LayoutAwarePage
    {
        public NationalGeographicViewPage()
        {
            InitializeComponent();
        }
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            if (CoreApplication.Properties.ContainsKey(navigationParameter.ToString()))
            {
                ...
                if (parameter is object[])
                {
                    ...
                    DefaultViewModel["NationalGeographicSelectedItem"] =
