...
namespace MagicLockScreen_Service_GooglePicasaService.UI.Views
{
    ...
    /// </summary>
    public sealed partial class GooglePicasaSingleViewPage : LayoutAwarePage
    {
        public GooglePicasaSingleViewPage()
        {
            InitializeComponent();
        }
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            if (CoreApplication.Properties.ContainsKey(navigationParameter.ToString()))
            {
                ...
                {
                    DefaultViewModel =
                        new GooglePicasaSingleViewPageViewModel(this, pageState);
                    DefaultViewModel["GooglePicasaSelectedItem"] =
