...
using MagicLockScreen_Service_MicrosoftWallpaperService.UI.ViewModels;
...
namespace MagicLockScreen_Service_MicrosoftWallpaperService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class MicrosoftWallpaperServiceChannelPage : LayoutAwarePage
    {
        public MicrosoftWallpaperServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new MicrosoftWallpaperServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding {Source = FindName("microsoftWallpaperItemsViewSource") as CollectionViewSource});
