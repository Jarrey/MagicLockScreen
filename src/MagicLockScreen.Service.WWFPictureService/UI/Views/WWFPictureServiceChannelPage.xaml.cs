...
using MagicLockScreen_Service_WWFPictureService.UI.ViewModels;
...
namespace MagicLockScreen_Service_WWFPictureService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class WWFPictureServiceChannelPage : LayoutAwarePage
    {
        public WWFPictureServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new WWFPictureServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding
                                        {
                                            Source = FindName("wwfPictureItemsViewSource") as CollectionViewSource
                                        });
