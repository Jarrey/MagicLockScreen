...
namespace MagicLockScreen_Service_MicrosoftWallpaperService.UI.Views
{
    ...
    /// </summary>
    public sealed partial class MicrosoftWallpaperViewPage : LayoutAwarePage
    {
        public MicrosoftWallpaperViewPage()
        {
            InitializeComponent();
        }
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            if (CoreApplication.Properties.ContainsKey(navigationParameter.ToString()))
            {
                ...
                if (parameter is object[])
                {
                    ...
                    DefaultViewModel["MicrosoftWallpaperSelectedItem"] =
