...
using MagicLockScreen_Service_NationalGeographicService.UI.ViewModels;
...
namespace MagicLockScreen_Service_NationalGeographicService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class NationalGeographicServiceChannelPage : LayoutAwarePage
    {
        public NationalGeographicServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new NationalGeographicServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding
                                        {
                                            Source =
                                                FindName("nationalGeographicItemsViewSource") as CollectionViewSource
                                        });
