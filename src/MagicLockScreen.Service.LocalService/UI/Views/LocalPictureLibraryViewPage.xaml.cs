...
namespace MagicLockScreen_Service_LocalService.UI.Views
{
    ...
    /// </summary>
    public sealed partial class LocalPictureLibraryViewPage : LayoutAwarePage
    {
        public LocalPictureLibraryViewPage()
        {
            InitializeComponent();
        }
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            if (CoreApplication.Properties.ContainsKey(navigationParameter.ToString()))
            {
                ...
                if (parameter is object[])
                {
                    ...
                    DefaultViewModel["LocalPictureLibrarySelectedItem"] =
