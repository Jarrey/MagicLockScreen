...
using MagicLockScreen_Service_OceanPODService.UI.ViewModels;
...
namespace MagicLockScreen_Service_OceanPODService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class OceanPODServiceChannelPage : LayoutAwarePage
    {
        public OceanPODServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new OceanPODServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding {Source = FindName("oceanPODItemsViewSource") as CollectionViewSource});
