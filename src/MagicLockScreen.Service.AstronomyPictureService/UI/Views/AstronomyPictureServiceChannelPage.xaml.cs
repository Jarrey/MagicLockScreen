...
using MagicLockScreen_Service_AstronomyPictureService.UI.ViewModels;
...
namespace MagicLockScreen_Service_AstronomyPictureService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class AstronomyPictureServiceChannelPage : LayoutAwarePage
    {
        public AstronomyPictureServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new AstronomyPictureServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding
                                        {
                                            Source = FindName("astronomyPictureItemsViewSource") as CollectionViewSource
                                        });
