...
using MagicLockScreen_Service_WikiMediaPODService.UI.ViewModels;
...
namespace MagicLockScreen_Service_WikiMediaPODService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class WikiMediaPODServiceChannelPage : LayoutAwarePage
    {
        public WikiMediaPODServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new WikiMediaPODServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding
                                        {
                                            Source = FindName("wikiMediaPODItemsViewSource") as CollectionViewSource
                                        });
