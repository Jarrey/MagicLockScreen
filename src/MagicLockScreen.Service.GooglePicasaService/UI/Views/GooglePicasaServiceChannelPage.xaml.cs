...
namespace MagicLockScreen_Service_GooglePicasaService.UI.Views
{
    ...
    /// </summary>
    public sealed partial class GooglePicasaServiceChannelPage : LayoutAwarePage
    {
        public GooglePicasaServiceChannelPage()
        {
            InitializeComponent();
        }
        ...
        {
            DefaultViewModel =
                new GooglePicasaServiceChannelPageViewModel(this, pageState);
        }
