...
using MagicLockScreen_Service_InterfaceLIFTService.UI.ViewModels;
...
namespace MagicLockScreen_Service_InterfaceLIFTService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class InterfaceLIFTServiceChannelPage : LayoutAwarePage
    {
        public InterfaceLIFTServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new InterfaceLIFTServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding
                                        {
                                            Source = FindName("interfaceLIFTItemsViewSource") as CollectionViewSource
                                        });
