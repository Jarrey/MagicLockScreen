...
using MagicLockScreen_Service_BingImageService.UI.ViewModels;
...
namespace MagicLockScreen_Service_BingImageService.UI.Views
{
    /// <summary>
    ///     A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class BingImageServiceChannelPage : LayoutAwarePage
    {
        public BingImageServiceChannelPage()
        {
            InitializeComponent();
            RefreshContent();
        }
        ...
        {
            DefaultViewModel =
                new BingImageServiceChannelPageViewModel(this, pageState);
        }
        ...
        private GridView GenerateItemGridView()
        {
            ...
            itemGridView.SetBinding(ItemsControl.ItemsSourceProperty,
                                    new Binding {Source = FindName("bingImageItemsViewSource") as CollectionViewSource});
