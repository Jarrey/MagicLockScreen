...
using MagicLockScreen_Service_GooglePicasaService.Resources;
...
{
    public class GooglePicasaServiceChannelModel : MagicLockScreenServiceChannelModel
    {
        public GooglePicasaServiceChannelModel(ServiceChannel channel)
            : base(channel)
        {
            Index = 4;
            ...
            PrimaryViewType = typeof (GooglePicasaServiceChannelPage);
        }

        public override bool IsEnabled
        {
            get { return (bool) AppSettings.Instance[AppSettings.SERVICE_CHANNEL_STATUS_GPSC]; }
            set
            {
                base.IsEnabled = value;
                AppSettings.Instance[AppSettings.SERVICE_CHANNEL_STATUS_GPSC] = value;
